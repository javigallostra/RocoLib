...
def get_boulders_list(gym, filters, database) -> list:
    """
    ...
    boulders = [BoulderProblem(database, gym, b_info)
...
def get_boulder_by_name(gym, name, db) -> BoulderProblem:
...
def update_boulder_by_id(gym, boulder, db) -> bool:
